IF NOT EXISTS (SELECT * FROM sys.tables WHERE name='logging_event')    
...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name='logging_event_property')
...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name='logging_event_exception')
